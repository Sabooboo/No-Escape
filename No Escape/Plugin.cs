...
namespace No_Escape
{
    ...
    public class Plugin
    {
        ...
        // public const string HarmonyId = "com.github.YourGitHub.No_Escape";
        // internal static readonly HarmonyLib.Harmony harmony = new HarmonyLib.Harmony(HarmonyId);

        internal static Plugin Instance { get; private set; }
        internal static IPALogger Log { get; private set; }
        // internal static No_EscapeController PluginController { get { return No_EscapeController.Instance; } }
        ...
        public Plugin(IPALogger logger, Zenjector zenjector)
        {
            ...
            zenjector.OnGame<PauseMenuInstaller>().OnlyForStandard();
            zenjector.OnMenu<SettingsInstaller>();
        }
